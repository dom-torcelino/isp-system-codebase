...
import { cn } from "./ui/utils"; // Note: Adjust path if your utils are elsewhere
...
// Why: Explicitly define the routing contract.
interface NavItem {
  id: ModuleName;
  href: string;
...
export function LeftNav({
  ...
  // Why: Map the module IDs directly to their Next.js route paths.
        ...
        <TooltipProvider>
          <nav className={cn("space-y-1", collapsed ? "px-2" : "px-3")}>
            {navItems.map((item) => {
              ...
              // Why: startsWith ensures nested routes (e.g. /tickets/123) keep the parent nav item highlighted.
