...
import { Ticket, TicketStatus, TicketBoard, ModalType, TicketNote, TicketHistory } from '@/features/tickets/types/ticketing';
import { buildInitialBoard, buildTicketMap } from '@/features/tickets/data/ticket-data';
